"""Custom Wrapper around Huggingface text generation inference API."""
import os
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            try:
                ...
                print("WARNING: Did you set the os.environ['HF_API_TOKEN'] variable?")
                raise e
        except ImportError:
            raise ImportError(
